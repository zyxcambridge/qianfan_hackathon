...
export declare class BaseServiceIO implements ServiceIO {
    ...
    private request;
    callServiceAPI(messages: Messages, pMessages: MessageContentI[], _?: File[]): Promise<void>;
    callApiWithFiles(body: any, messages: Messages, pMessages: MessageContentI[], files: File[]): Promise<void>;
